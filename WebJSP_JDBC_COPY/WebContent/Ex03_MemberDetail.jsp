...
<body>
	<table
		...
		<tr>
			...
			<td style="width: 700px"><c:set var="list"
					value="${requestScope.koreamember}" /> <!--  
				회원리스트 출력
				...
				<table
					...
					<tr>
						...
						<td style="width: 100px">${list.pwd}</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="width: 100px">${list.age}</</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td style="width: 100px">${list.email}</td>
					</tr>
					<tr>
						<td colspan="2"><a href="MemberListServlet">목록가기</a></td>
					</tr>
				</table> </td>
		</tr>
		<tr>
