	...
	<table
		...
		<tr>
			...
			<td style="width: 700px">
				<form action="MemberEditok" method="post">
						...
						<table
							...
							<tr>
								...
								<td>
									...
									<c:if test="${member.gender=='여'}"> checked </c:if>>여자
									<input type="radio" name="gender" id="gender" value="남"
									<c:if test="${member.gender=='남'}"> checked </c:if>>남자
								</td>
							</tr>
							<tr>
								<td>이메일</td>
							...
							<tr>
								...
								<a href='MemberListServlet'>리스트이동</a></td>
						</table>
