...
<%
	...
	//     D:\bit\WEBJSP\Labs\WebJSP\WebContent\Ex11_WebApp_RealPath.jsp
	//    /WebJSP 실경로(배포 경로 ) : D:\bit155\WebJSP\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\
	// E:\WEBJSP\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP
	...
	//E:\WEBJSP\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\WebJSP

	String filePath = application.getRealPath(resourcepath); 
	//  /download/note.txt
	out.print("real path : " + filePath + "<br>");
	//E:\WEBJSP\Labs\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\WebJSP\download\note.txt
